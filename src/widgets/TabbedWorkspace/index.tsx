...
import { SPECIAL_TAB_IDX, TabbedWorkspaceContext, TabbedWorkspaceContextProvider } from './context';
import Workspace from '../Workspace';
import { ProtocolComponentMap } from './types';


export interface TabbedWorkspaceProps<Protocol extends string> {
  stateKey: string
  protoConfig: ProtocolComponentMap<Protocol>
}

const TabbedWorkspace: React.FC<TabbedWorkspaceProps<any>> = function ({
  stateKey,
}) {
  ...
  return (
    <TabbedWorkspaceContextProvider stateKey={stateKey}>
      <Workspace
          css={css`
            flex: 1 1 auto;
          `}
